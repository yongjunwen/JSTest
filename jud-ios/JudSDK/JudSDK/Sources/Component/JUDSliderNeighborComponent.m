...
@protocol JUDSliderNeighborDelegate, JUDSliderNeighborDataSource;

@interface JUDSliderNeighborView: UIView
@property (nonatomic, strong) JUDIndicatorView *indicator;
@property (nonatomic, weak) id<JUDSliderNeighborDelegate> delegate;
@property (nonatomic, weak) id<JUDSliderNeighborDataSource> dataSource;
...
@implementation JUDSliderNeighborView
...
- (void)setDataSource:(id<JUDSliderNeighborDataSource>)dataSource
{
...
- (void)setDelegate:(id<JUDSliderNeighborDelegate>)delegate
{
...
{
    NSInteger count = 0;
    CGFloat spacing = [self valueForOption:JUDSliderNeighborOptionSpacing withDefault:1.0];
    ...
    return [self valueForOption:JUDSliderNeighborOptionCount withDefault:count];
}
...
- (CGFloat)alphaForItemWithOffset:(CGFloat)offset
{
    ...
    fadeMin = [self valueForOption:JUDSliderNeighborOptionFadeMin withDefault:fadeMin];
    fadeMax = [self valueForOption:JUDSliderNeighborOptionFadeMax withDefault:fadeMax];
    fadeRange = [self valueForOption:JUDSliderNeighborOptionFadeRange withDefault:fadeRange];
    fadeMinAlpha = [self valueForOption:JUDSliderNeighborOptionFadeMinAlpha withDefault:fadeMinAlpha];
...
- (void)transformItemView:(UIView *)view atIndex:(NSInteger)index
{
    ...
    showBackfaces = !![self valueForOption:JUDSliderNeighborOptionShowBackfaces withDefault:showBackfaces];
    
    view.superview.hidden = !(showBackfaces ?: (transform.m33 > 0.0));
}

NSComparisonResult sliderNeighorCompareViewDepth(UIView *view1, UIView *view2, JUDSliderNeighborView *self)
{
    //compare depths
...
- (void)layOutItemViews
{
    ...
    //update wrap
    _wrapEnabled = YES;
    _wrapEnabled = !![self valueForOption:JUDSliderNeighborOptionWrap withDefault:_wrapEnabled];
    ...
    _offsetMultiplier = 1.0;
    _offsetMultiplier = [self valueForOption:JUDSliderNeighborOptionOffsetMultiplier withDefault:_offsetMultiplier];
...
- (CGFloat)valueForOption:(JUDSliderNeighborOption)option withDefault:(CGFloat)value
{
...
@implementation NSObject (JUDSliderNeighborView)

- (NSUInteger)numberOfPlaceholdersInSliderNeighborView:(__unused JUDSliderNeighborView *)sliderNeighbor { return 0; }
- (void)sliderNeighborWillBeginScrollingAnimation:(__unused JUDSliderNeighborView *)sliderNeighbor {}
- (void)sliderNeighborDidEndScrollingAnimation:(__unused JUDSliderNeighborView *)sliderNeighbor {}
- (void)sliderNeighborDidScroll:(__unused JUDSliderNeighborView *)sliderNeighbor {}

- (void)sliderNeighborCurrentItemIndexDidChange:(__unused JUDSliderNeighborView *)sliderNeighbor {}
- (void)sliderNeighborWillBeginDragging:(__unused JUDSliderNeighborView *)sliderNeighbor {}
- (void)sliderNeighborDidEndDragging:(__unused JUDSliderNeighborView *)sliderNeighbor willDecelerate:(__unused BOOL)decelerate {}
- (void)sliderNeighborWillBeginDecelerating:(__unused JUDSliderNeighborView *)sliderNeighbor {}
- (void)sliderNeighborDidEndDecelerating:(__unused JUDSliderNeighborView *)sliderNeighbor {}

- (BOOL)sliderNeighbor:(__unused JUDSliderNeighborView *)sliderNeighbor shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)sliderNeighbor:(__unused JUDSliderNeighborView *)sliderNeighbor didSelectItemAtIndex:(__unused NSInteger)index {}

- (CGFloat)sliderNeighborItemWidth:(__unused JUDSliderNeighborView *)sliderNeighbor { return 0; }
- (CATransform3D)sliderNeighbor:(__unused JUDSliderNeighborView *)sliderNeighbor
   itemTransformForOffset:(__unused CGFloat)offset
            baseTransform:(CATransform3D)transform { return transform; }
- (CGFloat)sliderNeighbor:(__unused JUDSliderNeighborView *)sliderNeighbor
     valueForOption:(__unused JUDSliderNeighborOption)option
        withDefault:(CGFloat)value { return value; }

@end

@interface JUDSliderNeighborComponent() {
    JUDPixelType neighborSpace;
    CGFloat neighborAlpha;
    CGFloat neighborScale;
    CGFloat currentItemScale;
}

@property (nonatomic, strong) JUDSliderNeighborView *sliderView;
...
@implementation JUDSliderNeighborComponent
...
- (instancetype)initWithRef:(NSString *)ref type:(NSString *)type styles:(NSDictionary *)styles attributes:(NSDictionary *)attributes events:(NSArray *)events judInstance:(JUDSDKInstance *)judInstance {
    if (self = [super initWithRef:ref type:type styles:styles attributes:attributes events:events judInstance:judInstance]) {
        ...
        self->neighborSpace = [JUDConvert JUDPixelType:@(DEFAULT_NEIGHBOR_SPACE) scaleFactor:self.judInstance.pixelScaleFactor];
        _scrollable = YES;
...
- (UIView *)loadView
{
    _sliderView = [[JUDSliderNeighborView alloc] init];
    return _sliderView;
}
...
- (void)viewDidLoad
{
    _sliderView = (JUDSliderNeighborView *)self.view;
...
- (void)insertSubview:(JUDComponent *)subcomponent atIndex:(NSInteger)index
{
    ...
    if (!subcomponent->_lazyCreateView || (self->_lazyCreateView && [self isViewLoaded])) {
        ...
        JUDSliderNeighborView *sliderView = (JUDSliderNeighborView *)self.view;
        ...
        if (index == -1) {
            ...
            for (int i = 0; i < [self.items count]; ++i) {
                ...
                if ([self.items[i] isKindOfClass:[JUDIndicatorView class]]) {
                    offset++;
                }
            }
...
- (void)setAttributes:(NSDictionary *)attributes
{
    ...
    if (attributes[@"scrollable"]) {
        _scrollable = attributes[@"scrollable"] ? [JUDConvert BOOL:attributes[@"scrollable"]] : YES;
        ((JUDSliderNeighborView *)self.view).scrollEnabled = _scrollable;
    }
}
...
- (void)setNeighborSpace:(NSDictionary *)attributes{
    if(attributes[@"neighborSpace"]) {
        self->neighborSpace = [JUDConvert JUDPixelType:attributes[@"neighborSpace"] scaleFactor:self.judInstance.pixelScaleFactor];
    }
}

- (void)setNeighborAlpha:(NSDictionary *)attributes {
    if (attributes[@"neighborAlpha"]) {
        self->neighborAlpha = [JUDConvert CGFloat:attributes[@"neighborAlpha"]];
...
- (void)setCurrentItemScale:(NSDictionary *)attributes {
    if (attributes[@"currentItemScale"]) {
        self->currentItemScale = [JUDConvert CGFloat:attributes[@"currentItemScale"]];
...
{
    if (attributes[@"neighborScale"]) {
        self->neighborScale = [JUDConvert CGFloat:attributes[@"neighborScale"]];
...
{
    JUDSliderNeighborView *sliderNeighborView = (JUDSliderNeighborView *)self.view;
...
- (NSInteger)numberOfItemsInSliderNeighbor:(JUDSliderNeighborView *)sliderNeighbor {
    return [self.items count];
}

- (NSInteger)numberOfPlaceholdersInsliderNeighbor:(JUDSliderNeighborView *)sliderNeighbor {
    return 2;
}

- (UIView *)sliderNeighbor:(JUDSliderNeighborView *)sliderNeighbor viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view {
...
- (BOOL)sliderNeighbor:(JUDSliderNeighborView *)sliderNeighbor shouldSelectItemAtIndex:(NSInteger)index {
    
    return YES;
}

- (UIView *)sliderNeighbor:(JUDSliderNeighborView *)sliderNeighbor placeholderViewAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    
    return view;
}

- (void)sliderNeighborDidEndScrollingAnimation:(JUDSliderNeighborView *)sliderNeighbor
{
    [self updateSliderPage:YES];
}

- (void)sliderNeighbor:(JUDSliderNeighborView *)sliderView didScrollToItemAtIndex:(NSInteger)index
{
...
- (void)sliderNeighborWillBeginDragging:(JUDSliderNeighborView *)sliderNeighbor
{
    [self _stopAutoPlayTimer];
}

- (void)sliderNeighborDidEndDragging:(JUDSliderNeighborView *)sliderNeighbor willDecelerate:(BOOL)decelerate {
    if (_autoPlay) {
        [self _startAutoPlayTimer];
    }
}
