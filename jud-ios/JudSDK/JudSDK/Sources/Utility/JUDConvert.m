...
@implementation JUDConvert

#pragma mark Number & String & Collection

#define JUD_NUMBER_CONVERT(type, op) \
+ (type)type:(id)value {\
...
JUD_NUMBER_CONVERT(BOOL, boolValue)
JUD_NUMBER_CONVERT(int, intValue)
JUD_NUMBER_CONVERT(short, shortValue)
JUD_NUMBER_CONVERT(int64_t, longLongValue)
JUD_NUMBER_CONVERT(uint8_t, unsignedShortValue)
JUD_NUMBER_CONVERT(uint16_t, unsignedIntValue)
JUD_NUMBER_CONVERT(uint32_t, unsignedLongValue)
JUD_NUMBER_CONVERT(float, floatValue)
JUD_NUMBER_CONVERT(double, doubleValue)
JUD_NUMBER_CONVERT(NSInteger, integerValue)
JUD_NUMBER_CONVERT(NSUInteger, unsignedIntegerValue)
...
+ (CGFloat)CGFloat:(id)value
{
    if ([value isKindOfClass:[NSString class]]) {
        ...
        if ([valueString hasSuffix:@"px"] || [valueString hasSuffix:@"jud"]) {
...
+ (NSString *)NSString:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        ...
        JUDLogError(@"Convert Error:%@ can not be converted to string", value);
    }
...
+ (JUDPixelType)JUDPixelType:(id)value scaleFactor:(CGFloat)scaleFactor
{
    ...
    if ([value isKindOfClass:[NSString class]] && [value hasSuffix:@"jud"]) {
        return pixel;
    }
...
+ (JUDBorderStyle)JUDBorderStyle:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        if ([value isEqualToString:@"solid"]) {
            return JUDBorderStyleSolid;
        } else if ([value isEqualToString:@"dotted"]) {
            return JUDBorderStyleDotted;
        } else if ([value isEqualToString:@"dashed"]) {
            return JUDBorderStyleDashed;
        }
    }
...
+ (JUDPositionType)JUDPositionType:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        if ([value isEqualToString:@"relative"]) {
            return JUDPositionTypeRelative;
        } else if ([value isEqualToString:@"absolute"]) {
            return JUDPositionTypeAbsolute;
        } else if ([value isEqualToString:@"sticky"]) {
            return JUDPositionTypeSticky;
        } else if ([value isEqualToString:@"fixed"]) {
            return JUDPositionTypeFixed;
        }
    }
...
+ (JUDTextStyle)JUDTextStyle:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        ...
        if ([string isEqualToString:@"normal"])
            return JUDTextStyleNormal;
        else if ([string isEqualToString:@"italic"])
            return JUDTextStyleItalic;
    }
    return JUDTextStyleNormal;
}
...
+ (CGFloat)JUDTextWeight:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        NSString *string = (NSString *)value;
        if ([string isEqualToString:@"normal"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0:UIFontWeightRegular;
        else if ([string isEqualToString:@"bold"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.4:UIFontWeightBold;
        else if ([string isEqualToString:@"100"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?-0.8:UIFontWeightUltraLight;
        else if ([string isEqualToString:@"200"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?-0.6:UIFontWeightThin;
        else if ([string isEqualToString:@"300"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?-0.4:UIFontWeightLight;
        else if ([string isEqualToString:@"400"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0:UIFontWeightRegular;
        else if ([string isEqualToString:@"500"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.23:UIFontWeightMedium;
        else if ([string isEqualToString:@"600"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.3:UIFontWeightSemibold;
        else if ([string isEqualToString:@"700"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.4:UIFontWeightBold;
        else if ([string isEqualToString:@"800"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.56:UIFontWeightHeavy;
        else if ([string isEqualToString:@"900"])
            return JUD_SYS_VERSION_LESS_THAN(@"8.2")?0.62:UIFontWeightBlack;
...
+ (JUDTextDecoration)JUDTextDecoration:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        ...
        if ([string isEqualToString:@"none"])
            return JUDTextDecorationNone;
        else if ([string isEqualToString:@"underline"])
            return JUDTextDecorationUnderline;
        else if ([string isEqualToString:@"line-through"])
            return JUDTextDecorationLineThrough;
    }
    return JUDTextDecorationNone;
}
...
+ (JUDImageQuality)JUDImageQuality:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        ...
        if ([string isEqualToString:@"original"])
            return JUDImageQualityOriginal;
        else if ([string isEqualToString:@"normal"])
            return  JUDImageQualityNormal;
        else if ([string isEqualToString:@"low"])
            return  JUDImageQualityLow;
        else if ([string isEqualToString:@"high"])
            return  JUDImageQualityHigh;
    }
...
+ (JUDImageSharp)JUDImageSharp:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        ...
        if ([string isEqualToString:@"sharpen"])
            return JUDImageSharpening;
        else if ([string isEqualToString:@"unsharpen"])
            return JUDImageSharpeningNone;
    }
    return  JUDImageSharpeningNone;
}
...
+ (JUDScrollDirection)JUDScrollDirection:(id)value
{
    if([value isKindOfClass:[NSString class]]){
        NSString *string = (NSString *)value;
        if ([string isEqualToString:@"none"])
            return JUDScrollDirectionNone;
        else if ([string isEqualToString:@"vertical"])
            return JUDScrollDirectionVertical;
        else if ([string isEqualToString:@"horizontal"])
            return JUDScrollDirectionHorizontal;
    }
    return JUDScrollDirectionVertical;
}
...
+ (JUDVisibility)JUDVisibility:(id)value
{
    if ([value isKindOfClass:[NSString class]]) {
        NSString *string = (NSString *)value;
        if ([string isEqualToString:@"visible"]) {
            return JUDVisibilityShow;
        } else if ([string isEqualToString:@"hidden"]) {
            return JUDVisibilityHidden;
        }
    }
...
@implementation JUDConvert (Deprecated)

+ (JUDPixelType)JUDPixelType:(id)value
{
    CGFloat pixel = [self CGFloat:value];
    
    return pixel * JUDScreenResizeRadio();
}
