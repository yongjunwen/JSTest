...
@interface JUDStorageTests : XCTestCase

@property (nonatomic, strong) JUDStorageModule *storage;
...
@implementation JUDStorageTests

- (void)setUp {
    [super setUp];
    
    self.directory = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject;
    self.directory = [self.directory stringByAppendingPathComponent:@"judstorage"];
    NSLog(@"---storage directory: %@",self.directory);
    self.filePath = [self.directory stringByAppendingPathComponent:@"judstorage.plist"];
    self.infoPath = [self.directory stringByAppendingPathComponent:@"judstorage.info.plist"];
    self.indexPath = [self.directory stringByAppendingPathComponent:@"judstorage.index.plist"];
    ...
    self.storage = [JUDStorageModule new];
